            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="product__item">
                    ...
                    <div class="product__item__text">
                        ...
                        <div class="product__price">$ <?= $single_feature_product['product_price']?></div>
                    </div>
                </div>
            </div>
            <?php }?>
...
<section >
        <?php foreach ($slides as $slide) { ?>
            <div class="m-auto banner set-bg" data-setbg="assets/img/banner/<?= $slide['slider_image']?>">
        <?php } ?>
                ...
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        ...
                        <div class="trend__item__text">
                            ...
                            <div class="product__price">$ <?= $featured['product_price'] ?> </div>
                        </div>
                    </div>
                    <?php } ?>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 p-0">
                <div class="discount__pic">
                    <img src="assets/img/<?= $discount['discount_image']?>" alt="">
                </div>
            </div>
            <div class="col-lg-6 p-0">
                <div class="discount__text">
                    <div class="discount__text__title">
                        <span>Discount</span>
                        <h2><?= $discount['discount_title']?></h2>
                        <h5><span>Sale up to</span> <?= $discount['discount_percentage']?>%</h5>
                    </div>
                    <div class="discount__countdown" id="countdown-time">
                        <div class="countdown__item">
                            <span id="countdown__day"><?= $discount['discount_days']?></span>
                            <p>Days</p>
                        </div>
                        <div class="countdown__item">
                            <span><?= $discount['discount_hours']?></span>
                            <p>Hour</p>
                        </div>
                        <div class="countdown__item">
                            <span><?= $discount['discount_mins']?></span>
                            <p>Min</p>
                        </div>
                        <div class="countdown__item">
                            <span>00</span>
