            ...
            <div class="header-content clearfix">
                ...
                <div class="header-left">
                    <div class="input-group icons">
                        ...
                        <input type="search" class="form-control" placeholder="Search Members" aria-label="Search Dashboard">
        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    <li class="nav-label"><a href="<?= base_url('dashboard')?>">Dashboard</a></li>
                    <li>
                    ...
                    <li>
                        <a href="<?= base_url('brand')?>">
                            <i class="icon-speedometer menu-icon"></i><span class="nav-text">Manage Brand</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('products')?>">
                            <i class="icon-speedometer menu-icon"></i><span class="nav-text">Manage Products</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('sliders')?>">
                            <i class="icon-speedometer menu-icon"></i><span class="nav-text">Manage Sliders</span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void()">
                            <i class="icon-speedometer menu-icon"></i><span class="nav-text">Theme Options</span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void()">
...
<div class="footer">
		<div class="copyright">
				<p>Copyright &copy; Designed & Developed by <a href="#">Sadiq</a> 2018</p>
		</div>
</div>
<!--**********************************
		Footer end
